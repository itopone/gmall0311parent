...
import com.atguigu.gmall0311.mock.util.RanOpt;
import com.atguigu.gmall0311.mock.util.RandomDate;
import com.atguigu.gmall0311.mock.util.RandomNum;
import com.atguigu.gmall0311.mock.util.RandomOptionGroup;
...
public class JsonMocker {
    ...
    String initStartupLog( ){
     ...
     `area` string COMMENT '城市' */
        ...
        String uid="uid"+ RandomNum.getRandInt(1,500);
